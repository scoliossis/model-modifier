...
- Allows you to modify the model of any entity via a texture pack [example pack](https://github.com/scoliossis/model-modifier/tree/master/example-resource-pack)
